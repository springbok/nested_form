...
Also changes the script that creates the new entry to do it AFTER the link rather than before it, to me it makes more sense to have new records inserted at the top of the view this is especially with lot of records.
